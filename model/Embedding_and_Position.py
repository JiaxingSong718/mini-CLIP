...
class EmbeddingwithPosition(nn.Module):
    def __init__(self, vocab_size, embedding_size, dropout=0.1, seq_max_len=100) -> None:
        super().__init__()
...
#     print('de_ids_tensor:', de_ids_tensor.size(), 'result_embedding:', embedding_result.size())
